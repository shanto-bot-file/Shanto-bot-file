...
(event.body.toLowerCase() == "বট জামাই দাও")) {
     return api.sendMessage("আমার বস ফারহান কে চোখে দেখো না নাকি_😒🥱", threadID);
   };
...
(event.body.toLowerCase() == "Tui left ne")) {
   ...
   if ((event.body.toLowerCase() == "হিমুর জামাই কে") || (event.body.toLowerCase() == "Himur jamai ke")) {
     return api.sendMessage("一আমার বস শান্ত হিমুর জামাই__🥺❤️‍🩹", threadID);
   };
